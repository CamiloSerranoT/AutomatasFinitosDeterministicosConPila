...
public class Lista extends JFrame implements ActionListener {
    ...
    public void crear() {
        ...
        jt1.setFont(new java.awt.Font("Tahoma", 1, 24));

        jb1.setFont(new java.awt.Font("Segoe UI Black", 0, 11)); 
        jb1.setText("Agregar función");
        ...
        if (e.getSource() == jb1) {
            ...
            if (e.getSource() == jb2) {
                ...
                if (e.getSource() == jb3) {
                    ...
                    if (e.getSource() == jb4) {
                        jt1.setText(control.ponerVacio(jt1.getText()));
                    }
                }
            }
        }
